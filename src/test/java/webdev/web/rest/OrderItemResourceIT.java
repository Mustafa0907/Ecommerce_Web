...
import webdev.repository.OrderItemRepository;
...
public class OrderItemResourceIT {
    ...
    public void createOrderItem() throws Exception {
        ...
        assertThat(testOrderItem.getCreatedondate()).isEqualTo(DEFAULT_CREATEDONDATE);
    ...
    public void updateOrderItem() throws Exception {
        ...
        OrderItem testOrderItem = orderItemList.get(orderItemList.size() - 1);
        assertThat(testOrderItem.getCreatedondate()).isEqualTo(UPDATED_CREATEDONDATE);
